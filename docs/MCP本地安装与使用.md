...
```text
%LOCALAPPDATA%\Programs\DaVinciGW\versions\1.1.2\davinci-gw-mcp.exe
```
...
command = 'C:\Users\YOUR_NAME\AppData\Local\Programs\DaVinciGW\versions\1.1.2\davinci-gw-mcp.exe'
